...
st.markdown("4. กดปุ่มเพื่อสร้างตาราง ระบบจะจัดทำตารางเปรียบเทียบและไฮไลท์สีเขียวที่ช่อง **Unit Price / Amount** ของเจ้าที่ถูกที่สุดทันที")
...
- ตรวจสอบตัวเลขให้ถูกต้องแม่นยำ 100% ตามหน้าเอกสาร"""
                ...
                # 7. สร้างตารางแบบ Flat Columns เพื่อไม่ให้ Streamlit แสดงผลเพี้ยนหรือดำมืด
                table_data = {}
                ...
                # 9. ฟังก์ชันไฮไลท์เฉพาะจุดที่จำเป็น ไม่ไปกวนสีพื้นหลังของธีม Streamlit
