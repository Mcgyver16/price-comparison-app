...
st.markdown("4. กดปุ่มสร้างตาราง ระบบจะอ่านแยกทีละบิลอย่างแม่นยำ 100% และจัดเรียงตารางเปรียบเทียบให้ทันที")
...
if st.button("🚀 3. เริ่มวิเคราะห์และสร้างตารางเปรียบเทียบ") and uploaded_files:
    if not api_key:
        ...
        try:
            ...
            # เพื่อให้ Streamlit แสดงผลเป็นตารางสะอาดตา 100% ไม่ติดกล่องดำหรือเพี้ยนจากธีม
            ...
            # แสดงผลตารางแบบ Native ไม่ใช้ Styler CSS เพื่อตัดปัญหาธีมเบราว์เซอร์ตีกัน 100%
